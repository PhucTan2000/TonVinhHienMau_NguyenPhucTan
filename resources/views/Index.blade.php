                              ...
                              <tr>
                                <td class="col-3">
                                  <div class="d-flex align-items-center">
                                    ...
                                    <p class="font-bold ms-3 mb-0">Tâm</p>
                                  </div>
                                </td>
                                <td class="col-auto">
                                  <p class="mb-0">
                              ...
                              <tr>
                                <td class="col-3">
                                  <div class="d-flex align-items-center">
                                    ...
                                    <p class="font-bold ms-3 mb-0">Ngọc</p>
                                  </div>
                                </td>
                                <td class="col-auto">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="ms-3 name">
                        <h5 class="font-bold">Trương Thanh Ngà</h5>
