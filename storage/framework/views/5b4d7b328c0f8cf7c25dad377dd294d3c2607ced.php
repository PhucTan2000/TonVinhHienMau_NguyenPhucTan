...
<?php $__env->startSection('title', 'Tìm Kiếm Thông Tin'); ?>
                    ...
                    <div class="card-body">
                      ...
                      <div class="table-responsive">
                        <table id="tableData" class="table table-bordered mb-0">
                          ...
                          <tbody>
                            <?php $__currentLoopData = $nguoihienmau; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pep): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                              <td class="text-bold-500"><?php echo e($pep->HoTen); ?></td>
                              <td><?php echo e(date('d/m/Y',strtotime($pep->NgaySinh))); ?></td>
                              <td class="text-bold-500"><?php echo e($pep->NoiLamViec); ?></td>
                              <td><?php echo e($pep->SDT); ?></td>
                              <td><?php echo e($pep->DiaChi); ?></td>
                              <td><?php echo e($pep->SoLanHien); ?></td>
                              <td><?php echo e($pep->Nhom_ABO); ?></td>
                              <td><?php echo e($pep->Nhom_Rh); ?></td>
                              <td>
                              <?php if( $pep->Muc_5 != NULL ): ?>
                                <img src="assets/images/logo/5_48px.png" />
                              <?php endif; ?>
                              <?php if( $pep->Muc_10 != NULL ): ?>
                                <img src="assets/images/logo/10_48px.png" />
                              <?php endif; ?>
                              <?php if( $pep->Muc_15 != NULL ): ?>
                                <img src="assets/images/logo/15_48px.png" />
                              <?php endif; ?>
                              <?php if( $pep->Muc_20 != NULL ): ?>
                                <img src="assets/images/logo/20_48px.png" />
                              <?php endif; ?>
                              <?php if( $pep->Muc_30 != NULL ): ?>
                                <img src="assets/images/logo/30_48px.png" />
                              <?php endif; ?>
                              <?php if( $pep->Muc_40 != NULL ): ?>
                                <img src="assets/images/logo/40_48px.png" />
                              <?php endif; ?>
                              <?php if( $pep->Muc_50 != NULL ): ?>
                                <img src="assets/images/logo/50_48px.png" />
                              <?php endif; ?>
                              <?php if( $pep->Muc_60 != NULL ): ?>
                                <img src="assets/images/logo/60_48px.png" />
                              <?php endif; ?>
                              <?php if( $pep->Muc_70 != NULL ): ?>
                                <img src="assets/images/logo/70_48px.png" />
                              <?php endif; ?>
                              <?php if( $pep->Muc_80 != NULL ): ?>
                                <img src="assets/images/logo/80_48px.png" />
                              <?php endif; ?>
                              <?php if( $pep->Muc_90 != NULL ): ?>
                                <img src="assets/images/logo/90_48px.png" />
                              <?php endif; ?>
                              <?php if( $pep->Muc_100 != NULL ): ?>
                                <img src="assets/images/logo/100_48px.png" />
                              <?php endif; ?>
                              </td>
                              <td><a href="/TimKiemTonVinh/<?php echo e($pep->Id); ?>" class="btn btn-primary btn-size">Sửa</a></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\TonVinhHienMau\resources\views/TimKiemTonVinh.blade.php ENDPATH**/ ?>